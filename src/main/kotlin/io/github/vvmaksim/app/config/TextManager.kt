...
object TextManager {
    object UI {
        ...
        const val MATCH_MOVES_LABEL_WITH_LINK = "Вставьте ссылку на анализ партии"
        const val MATCH_MOVES_LABEL_WITH_PGN = "Ходы в формате PGN"
        const val MATCH_MOVES_PLACEHOLDER_WITH_LINK = "https://lichess.org/CgEgzuVH"
        const val MATCH_MOVES_PLACEHOLDER_WITH_PGN = "1.e4 e5 2.Nf3 Nc6 ..."
