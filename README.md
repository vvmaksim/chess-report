...
<div align="center" style="margin: 20px 0;">
    <img src="docs/icons/app_icon.png" alt="Chess Report Logo" width="128"/>
</div>
...
- 💾 **Автоматическое сохранение настроек:** Приложение запоминает данные последнего отчета и автоматически заполняет поля при следующем запуске.
...
2.  **Получите данные о партиях**, используя один из способов ниже.
    ...
    > **⚠️ Важные замечания:**
    > *   Ссылка должна быть в формате `https://lichess.org/GAME_ID`..
...
В этом проекте использованы материалы сторонних разработчиков. Мы благодарны им за их работу.
Пожалуйста, ознакомьтесь с подробным списком ссылок в файле [ATTRIBUTIONS.md](ATTRIBUTIONS.md).
